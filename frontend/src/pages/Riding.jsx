        ...
        <div>
          ...
          <div className="flex flex-rows m-1">
            ...
            <div>
              ...
              <h2 className="text-lg">{rideData?.destination}</h2>
            </div>
          </div>
          <div className="border-t border-gray-300"></div>{" "}
          {/* Horizontal line */}
          <div className="flex flex-rows m-1">
            ...
            <div>
              <h3 className="text-xl pt-2 font-semibold">
                ₹{rideData?.fare.toFixed(1)}
              </h3>
              <h2 className="text-lg">Cash</h2>
            </div>
          </div>
          <button className="bg-[#a5de64] w-full text-white font-semibold mb-7 rounded px-4 py-2 mt-7 md-0">
            Make a payment
          </button>
        </div>
      </div>
